...
AGM.Modelling.BoolUnite( b1, b3 );
    ...
    var theface = AGM.Modelling.PickFace(AGM.Position(0, 0, L+1), AGM.Vector(0, 0, -1), 10e-4);
    var path = AGM.Object();
    result = AGM.Modelling.ConvertFaceToPath(theface, path);
	if ( !result )
	{
		ExitProgram;
	}
	...
	var trf1 = AGM.Transf();
	AGM.Modelling.TranslateTransf(AGM.Vector(0,0,-L+N), trf1);
	AGM.Modelling.ApplyTransformToBody(path, trf1);
